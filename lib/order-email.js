...
function describeEmailConfigIssue(fetchResult) {
    ...
    if (result.error === 'almacen_vacio') {
        return 'El pedido no tiene almacen_destino; no se puede resolver el SMTP de empresa.';
    }
    ...
    if (result.error === 'not_found') {
        return 'No hay Datos de Empresa para el almacen destino "' + almacenLabel + '". Configure Panel de Control > Datos de Empresa para ese almacen.';
    }
